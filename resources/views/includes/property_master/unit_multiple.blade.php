<div class="form-group">
    <label for="name" class="title-color">{{ __('property_master.unit_no_prefill_with_zero') }}
    </label>
...
<div class="form-group ">
    <label for="" class=" ">{{ __('property_master.no_of_units') }}</label>
    <input type="number" id="" name="no_of_units" class=" form-control ">
</div>
<div class="form-group">
    <label for="name" class="title-color">{{ __('property_master.start_unit_no') }}
    </label>
...
<div class="form-group">
    <label for="name" class="title-color">{{ __('property_master.unit_code_prefix') }}
    </label>
...
<div class="d-flex gap-3 justify-content-end">
    ...
    <button type="submit" class="btn btn--primary px-4">{{ __('general.next') }}</button>
</div>
