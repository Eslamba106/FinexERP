...
<head>
    ...
    <!-- Favicon -->
    <?php $web_config['fav_icon'] = 'Eslam'; ?>
    <link rel="shortcut icon" href="{{ asset('public/assets/finexerp_logo.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/back-end/css/toastr.cs') }}s">
</head>
