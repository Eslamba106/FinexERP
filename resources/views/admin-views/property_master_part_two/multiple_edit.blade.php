...
@section('title', __('property_master.edit_floor'))
@php
                            ...
                            <div class="col-md-12 floor_form  multiple-form" id="multiple-form">
                                <form action="{{ route('floor.floor_multiple_edit' , $main->id) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ __('property_master.floor_no_prefill_with_zero') }}
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ __('property_master.floor_code_prefix') }}
                                        </label>
