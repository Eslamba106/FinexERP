...
@endphp
@section('title', __('property_master.floors' ))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                <img width="60" src="{{ asset('/public/assets/back-end/img/floor.jpg') }}" alt="">
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-custom input-group-merge">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ __('property_master.search_by_floor_name') }}" aria-label="Search"
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ __('property_master.no_of_floor') }} </th>
